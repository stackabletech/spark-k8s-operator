...
This page covers authentication against external services only. To encrypt traffic between the Spark components themselves, see xref:usage-guide/encryption-in-transit.adoc[].

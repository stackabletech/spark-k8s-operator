...
:crd: {crd-ref}{crd-ref-release}&operator=spark-k8s-operator
:crd-sparkapplication: {crd-ref}/spark.stackable.tech/v1alpha1/sparkapplication{crd-ref-release}
:crd-sparkhistoryserver: {crd-ref}/spark.stackable.tech/v1alpha1/sparkhistoryserver{crd-ref-release}

...
:page-aliases: usage-guide/security.adoc
...
This page covers authentication against external services only. To encrypt traffic between the Spark components themselves, see xref:usage-guide/security/encryption-in-transit.adoc[].

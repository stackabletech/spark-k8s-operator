...
TIP: Read about xref:concepts:product-image-selection.adoc[] to find out how to specify the version to use, as well as how to run customized or mirrored product images.

...
|`spec.sparkImage`
| Spark image which will be deployed to driver and executor pods: must contain spark environment needed by the job e.g. `docker.stackable.tech/stackable/spark-k8s:3.2.1-hadoop3.2-stackable0.4.0`

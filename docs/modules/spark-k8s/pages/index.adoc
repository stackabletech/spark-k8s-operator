...
The SparkApplication resource is the main point of interaction with the Operator. An exhaustive list of options is given on the xref:crd-reference.adoc[] page. You can specify a custom image etc.etc (TODO)

=== Kubernetes resources

For every SparkApplication deployed to the cluster the Operator creates a Job

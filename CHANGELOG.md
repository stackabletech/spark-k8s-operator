...
- BREAKING: use resource limit struct instead of passing spark configuration arguments ([#147, #160])
...
[#160]: https://github.com/stackabletech/spark-k8s-operator/pull/160
